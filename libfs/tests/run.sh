...
export LD_LIBRARY_PATH=:${STRATA_ROOT}/libfs/build:${STRATA_ROOT}/shim/glibc-build/:${STRATA_ROOT}/libfs/lib/libspdk/libspdk/:/usr/local/lib64:${STRATA_ROOT}/libfs/src/storage/spdk/:/usr/lib/:/usr/lib/x86_64-linux-gnu/:/lib/x86_64-linux-gnu/:${LD_LIBRARY_PATH}
